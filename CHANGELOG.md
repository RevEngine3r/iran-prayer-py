...
### Fixed
- Added `tzdata` dependency for Windows platform to fix `ZoneInfoNotFoundError`
- Windows systems now properly load timezone data for `Asia/Tehran`

### Changed
- Updated installation instructions to include platform-specific dependencies
...
[1.0.1]: https://github.com/RevEngine3r/iran-prayer-py/releases/tag/v1.0.1
